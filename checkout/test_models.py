...
class TestCheckoutModels(TestCase):
    ...
    def test_order_total(self):
        ...
        actual_order_total = self.order_test.order_total.quantize(
            Decimal('0.01'))
    ...
    def test_delivery_cost_calculation(self):
        ...
        expected_delivery_cost = expected_delivery_cost.quantize(
            Decimal('0.01'))
        actual_delivery_cost = self.order_test.delivery_cost.quantize(
            Decimal('0.01'))
    ...
    def test_order_line_item_product_name(self):
        ...
        """
        self.assertEqual(
            self.order_line_item_test_1.product.name, "Test Product 1")
